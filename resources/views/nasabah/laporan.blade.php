...
<div class="card mb-3">
    <div class="card-header">
        <a href="{{url('/nasabah/laporan/export')}}" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i></a>
        <a href="{{url('/nasabah/laporan/cetak')}}" class="btn btn-danger btn-sm" target="__blank"><i class="fas fa-print"></i></a>
    </div>
    <div class="card-body">
