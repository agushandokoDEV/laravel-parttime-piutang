...
<div class="card mb-3">
    ...
    <div class="card-body">
        <form action="{{url('/nasabah/usulan/surat/next5/'.$data->id.'/save')}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method("PUT")
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <table style="width: 100%;" id="table">
                    <tr>
                        <th>
                            <input type="file" name="docs_ID[]" multiple class="form-control @error('docs_ID') is-invalid @enderror my-2" style="width: 100%;">
                            @error('docs_ID')
                            <div class="invalid-feedback">
                                {{$message}}
                            </div>
            ...
            <div class="my-3">
                <a href="{{url('nasabah/usulan/surat/next4/' . $data->id)}}" type="submit" id="back" class="btn btn-secondary float-start"><i class="fas fa-arrow-left"></i> Back</a>
