...
<div class="card mb-3">
    ...
    <div class="card-body">
        <form action="{{url('/nasabah/home/update/')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="rincian" value="" class="form-control @error('rincian') is-invalid @enderror">
                        @error('rincian')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="nilai_rincian" id="nilai_rincian" value="{{number_format($nilai_rincian, 0,'','.')}}" class="form-control @error('nilai_rincian') is-invalid @enderror">
                        @error('nilai_rincian')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" readonly name="total_rincian" id="total_rincian" value="{{number_format($nilai_rincian, 0,'','.')}}" class="form-control @error('total_rincian') is-invalid @enderror">
                        @error('total_rincian')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
