...
<div class="card mb-3">
    <div class="card-header">
        <a href="<?php echo e(url('/nasabah/laporan/export')); ?>" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i></a>
        <a href="<?php echo e(url('/nasabah/laporan/cetak')); ?>" class="btn btn-danger btn-sm" target="__blank"><i class="fas fa-print"></i></a>
    </div>
    <div class="card-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Workspace\Website\upwork\piutang\master\5\piutang-bpkd\resources\views/nasabah/laporan.blade.php ENDPATH**/ ?>