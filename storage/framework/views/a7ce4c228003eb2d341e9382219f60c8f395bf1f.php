<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
    ...
    <li class="nav-item <?php echo e(request()->is('nasabah/laporan*') ? 'active' : ''); ?>">
        <a class="nav-link" href="<?php echo e(url('/nasabah/laporan')); ?>">
            <i class="fas fa-fw fa-file"></i>
            <span>Laporan</span>
        </a>
    </li>
...
<?php /**PATH D:\Workspace\Website\upwork\piutang\master\5\piutang-bpkd\resources\views/layouts/components/side.blade.php ENDPATH**/ ?>