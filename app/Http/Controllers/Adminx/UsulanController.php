...
class UsulanController extends  Controller
{
    ...
    {
        $data = SuratUsulan::with('file', 'file_ST', 'file_DL', 'file_ID', 'file_kriteria')->find($id);
        $showFile = SuratUsulan::with('file', 'file_ST', 'file_DL', 'file_ID', 'file_kriteria')->where('id', '=', $id)->get();
