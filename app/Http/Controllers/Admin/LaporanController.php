...
class LaporanController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = DB::table('surat_usulan_knkpls')
            ...
            ->groupBy('surat_usulans.id', 'jenis_piutangs.jenis', 'surat_usulan_knkpls.id', 'surat_balasan_knkpls.id', 'keputusan_gubernurs.id', 'berita_acaras.judul', 'pembayarans.id','users.id')
            ->select(
                'surat_usulans.*',
    ...
    public function export()
    {
        ...
        foreach ($data as $value) {
            ...
            if($value->tgl_keputusan == null)
            {

            }else {
                $sheet->setCellValue('P' . $row, Carbon::parse($value->tgl_keputusan)->translatedFormat('d-F-Y'));
            } 
            if($value->nomor_keputusan != null)
            {
